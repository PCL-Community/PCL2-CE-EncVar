        ...
        Catch ex As WebException
            ...
            Else
                ...
                If String.IsNullOrEmpty(Res) Then
                    Throw New WebException(GetLang("LangModExceptionRequestFailed", $"{ex.Status}，{ex.Message}，{Url}"), ex)
                Else
                    Throw New ResponsedWebException(GetLang("LangModExceptionReturnErrorCode", $"{ex.Status}，{ex.Message}，{Url}{vbCrLf}{Res}"), Res, ex)
                End If
            End If
        Catch ex As Exception
