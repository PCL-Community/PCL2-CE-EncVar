...
#Region "OptiFine 列表"
    ...
    Private Function LoadOptiFineGetError() As String
        If SelectedLoaderName = "NeoForge" OrElse SelectedLoaderName = "Quilt" Then Return GetLang("LangDownloadModLoaderIncompatible", SelectedLoaderName)
...
#Region "Forge 列表"
    ...
    Private Function LoadForgeGetError() As String
        ...
        For Each Version In Loader.Output
            ...
            If SelectedLoaderName IsNot Nothing AndAlso SelectedLoaderName IsNot "Forge" Then Return GetLang("LangDownloadModLoaderIncompatible", SelectedLoaderName)
...
#Region "NeoForge 列表"
    ...
    Private Function LoadNeoForgeGetError() As String
        ...
        If SelectedLoaderName IsNot Nothing AndAlso SelectedLoaderName IsNot "NeoForge" Then Return GetLang("LangDownloadModLoaderIncompatible", SelectedLoaderName)
    ...
    Private Function LoadFabricGetError() As String
        ...
        For Each Version As JObject In DlFabricListLoader.Output.Value("game")
            If Version("version").ToString = SelectedMinecraftId.Replace("∞", "infinite").Replace("Combat Test 7c", "1.16_combat-3") Then
                If SelectedLoaderName IsNot Nothing AndAlso SelectedLoaderName IsNot "Fabric" Then Return GetLang("LangDownloadModLoaderIncompatible", SelectedLoaderName)
                Return Nothing
            End If
        Next
        Return GetLang("LangDownloadInstallNoAvailableVersion")
...
#Region "Fabric API 列表"
    ...
    Private Function LoadFabricApiGetError() As String
        ...
        If SelectedAPIName IsNot Nothing AndAlso SelectedAPIName IsNot "Fabric API" Then Return GetLang("LangDownloadModLoaderIncompatible", SelectedLoaderName)
